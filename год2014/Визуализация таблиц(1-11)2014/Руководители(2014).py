...
xls_file = pd.read_excel('FILE76_01.01.2014_452_452.xls', 'Руководители', index_col=None)
os.chdir('C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2014')
xls_file[13:].to_csv('Первая часть.csv', encoding='utf-8',sep=';',index=False)
...
df.to_html('Руководители(2014).html',index=False)