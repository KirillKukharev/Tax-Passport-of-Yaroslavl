...
xls_file = pd.read_excel('FILE76_01.01.2014_452_452.xls', 'Раздел5', index_col=None)
os.chdir('C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2014')
xls_file[16:].to_csv('Пятая часть.csv', encoding='utf-8',sep=';',index=False)
df=pd.read_csv('Пятая часть.csv',sep=';', comment='#',index_col=None)
df = df.fillna('')
...
df.to_html('Таблица_5(2014).html',index=False)