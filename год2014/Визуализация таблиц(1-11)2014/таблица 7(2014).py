...
xls_file = pd.read_excel('FILE76_01.01.2014_452_452.xls', 'Раздел7', index_col=None)
os.chdir('C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2014')
xls_file[15:].to_csv('Седьмая часть.csv', encoding='utf-8',sep=';',index=False)
df=pd.read_csv('Седьмая часть.csv',sep=';', comment='#',index_col=None)
df = df.fillna('')
del df['Unnamed: 1']
...
arrays = [['', 'По состоянию на 01.01.2015', 'По состоянию на 01.01.2015', 'По состоянию на 01.01.2015','По состоянию на 01.01.2015','Изменение за 2014 год','Изменение за 2014 год','Изменение за 2014 год','Изменение за 2014 год'], df.columns]
...
df.to_html('Таблица_7(2014).html',index=False)