...
os.chdir("C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2014\\отсортированные разделы")
z=[]
file=open('База2014(1часть).csv',encoding="cp1251")
...
df.to_csv("result1part(2014).csv",encoding='cp1251', sep=';',index=False)