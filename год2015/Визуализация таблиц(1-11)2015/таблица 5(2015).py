...
xls_file = pd.read_excel('FILE76_01.01.2015_263_263.xls', 'Раздел5', index_col=None)
os.chdir('C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2015')
xls_file[16:].to_csv('Пятая часть2.csv', encoding='utf-8',sep=';',index=False)
df=pd.read_csv('Пятая часть2.csv',sep=';', comment='#',index_col=None)
df = df.fillna('')
...
df.to_html('Таблица_5(2015).html',index=False)
