...
os.chdir("C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2015\\Отсортированные разделы")
z=[]
file=open('База2015(1часть).csv',encoding="cp1251")
...
df.to_csv("result1part(2015).csv",encoding='cp1251', sep=';',index=False)