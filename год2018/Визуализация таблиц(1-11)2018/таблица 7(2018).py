...
xls_file = pd.read_excel('FILE76_01.01.2018_1191_1191.xls', 'Раздел7', index_col=None)
os.chdir('C:\\Users\\Кирилл\\Downloads\\PythonProject\\год2018')
xls_file[6:].to_csv('Седьмая часть5.csv', encoding='utf-8',sep=';',index=False)
df=pd.read_csv('Седьмая часть5.csv',sep=';', comment='#',index_col=None)
df = df.fillna('')
...
df.to_html('Таблица_7(2018).html',index=False)
